...
<img src="../assets/img/photo_dan.jpg" title="The image shows a very handsome and competent young man. It must be a black and white image of Daniel 😏" style="width: 20%; max-width: 256px; max-height: 256px; min-width: 50px; min-height: 50px; float: right; margin: .2em .2em 1em 1em"/>
...
💻 My last role was at a <abbr title="business to business">B2B</abbr> company in search optimisation and I worked quite a bit with <abbr title="Large Language Models">LLMs</abbr>. It is fun but can be, as every job in IT sometimes is, frustrating. I don't know what to make of these non-deterministic next-word prediction machines. I am currently looking for my next role that has more space for my psychology skills while keeping myself grounded in hands-on technical craftsmanship. This might lead towards consulting.
...
▶️ [Have a look at my CV](/cv/) for details on the things I've been doing in my life so far.

🤙 I am always interested in working on new projects, acquiring knowledge, connecting and finding out what other people (= you) are doing. So, [do get in touch](/me/say-hi) for a chat. Also in case you'd just like to have some <a href="/cv/languages">language tandem/exchange</a>.

<span lang="ja">よろしくお<span title="願【ねが】">願</span>いいたします。</span> <span lang="is">Gama að kynnast þér.</span>
